...
CREATE UNIQUE INDEX "notifications_recipient_key_unique" ON "notifications" USING btree ("recipient_id","key") WHERE "notifications"."key" is not null and "notifications"."deleted_at" is null;--> statement-breakpoint
